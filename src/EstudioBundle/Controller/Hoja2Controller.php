...
use EstudioBundle\Entity\Hoja2;
use EstudioBundle\Form\Hoja2Type;
...
class Hoja2Controller extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EstudioBundle:Hoja2')->findAll();

        return $this->render('EstudioBundle:Hoja2:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EstudioBundle:Hoja2:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EstudioBundle:Hoja2')->find($id);
        ...
        return $this->render('EstudioBundle:Hoja2:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EstudioBundle:Hoja2:edit.html.twig', array(
            'entity'      => $entity,
