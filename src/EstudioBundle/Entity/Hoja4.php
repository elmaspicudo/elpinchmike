...
class Hoja4
{
     ...
     * @var string
     */
    private $referenciaAutos;

    public function getReferenciaAutos()
    {
        return $this->referenciaAutos;
    }

    public function setReferenciaAutos($referenciaAutos)
    {
        $this->referenciaAutos = $referenciaAutos;
        return $this;
    }
}
