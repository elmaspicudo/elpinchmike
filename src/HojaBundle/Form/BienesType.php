...
class BienesType extends AbstractType
{
    /**
    ...
    {
        $builder
            ->add('Bienes_raices', new \EstudioBundle\Form\Bienes_raicesType())
            ->add('Bienes_autos', new \EstudioBundle\Form\Bienes_autosType())
            ...
            ->add('propiedadVivienda','choice', array(
                'choices'=>array(
                        'Propia' => 'Propia',
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'HojaBundle\Entity\Bienes'
        ));
    }
